    ...
    <div className="bg-slate-50 min-h-screen text-slate-900">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="mt-14 grid gap-6 lg:grid-cols-3">
          ...
          <div className="rounded-[28px] bg-[#002057] p-8 text-white shadow-sm">
            <h3 className="text-xl font-semibold text-slate-200">Metodologia</h3>
            <p className="mt-4 text-slate-200 leading-7">Trabalhamos com ciclos iterativos, prototipagem rápida e parceria entre alunos, professores e empresas para entregar resultados consistentes.</p>
          </div>
          <div className="rounded-[28px] bg-[#002057] p-8 text-white shadow-sm">
            <h3 className="text-xl font-semibold text-slate-200">Impacto</h3>
            <p className="mt-4 text-slate-200 leading-7">Os projetos visam gerar valor acadêmico e social, ampliando a visibilidade do núcleo e fortalecendo a cultura de inovação na instituição.</p>
          </div>
        </section>
      </main>
